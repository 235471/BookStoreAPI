...
const swaggerDefinition = {
  ...
  info: {
    ...
    version: "0.0.1",
    description:
      "Comprehensive API documentation detailing the Create, Read, Update, and Delete (CRUD) operations for books, authors, and publishers.",
  },
  servers: [
    {
      ...
      Author: {
        ...
        properties: {
          ...
          biography: {
            ...
            example:
              "Jane Austen was an English novelist known for her witty social commentary and sharp observations of human nature",
          },
        },
      },
      Publisher: {
